...
export type ConversationTagCreateInput = {
  ...
  conversation: Prisma.ConversationCreateNestedOneWithoutConversationTagsInput
  tag: Prisma.TagCreateNestedOneWithoutConversationTagsInput
}
...
export type ConversationTagUpdateInput = {
  ...
  conversation?: Prisma.ConversationUpdateOneRequiredWithoutConversationTagsNestedInput
  tag?: Prisma.TagUpdateOneRequiredWithoutConversationTagsNestedInput
}
...
export type ConversationTagOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"companyId" | "conversationId" | "tagId" | "createdAt", ExtArgs["result"]["conversationTag"]>
...
export interface ConversationTagDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const conversationTagWithCompanyIdOnly = await prisma.conversationTag.findMany({ select: { companyId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many ConversationTags and only return the `companyId`
   * const conversationTagWithCompanyIdOnly = await prisma.conversationTag.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more ConversationTags and only return the `companyId`
   * const conversationTagWithCompanyIdOnly = await prisma.conversationTag.updateManyAndReturn({
   *   select: { companyId: true },
   *   where: {
   *     // ... provide filter here
   *   },
